...
import { shoesModel } from "../models/shoes.models.js";
...
export const addImagenes = async (req, res) => {
    ...
    try {
        ...
        const producto = await shoesModel.create({
...
export const addImagenProducts = async (req, res) => {
    ...
    try {
        ...
        const producto = await shoesModel.findOne({ _id: id })
...
export const loadProductsForId = async (req, res) => {
    ...
    try {
        ...
        const product = await shoesModel.findById({ _id:id })
